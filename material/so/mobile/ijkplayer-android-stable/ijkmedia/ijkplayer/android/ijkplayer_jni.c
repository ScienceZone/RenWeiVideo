...
#define JNI_MODULE_PACKAGE      "cn/dolit/media/player"
#define JNI_CLASS_IJKPLAYER     "cn/dolit/media/player/DLMediaPlayer"
#define JNI_IJK_MEDIA_EXCEPTION "cn/dolit/media/player/DLMediaException"
...
{
    MPTRACE("DolitMediaPlayer_setDataSourceAndHeaders");
    int retval = 0;
...
{
    MPTRACE("DolitMediaPlayer_setVideoSurface");
    IjkMediaPlayer *mp = jni_get_media_player(env, thiz);
...
{
    MPTRACE("DolitMediaPlayer_prepareAsync");
    int retval = 0;
    IjkMediaPlayer *mp = jni_get_media_player(env, thiz);
...
{
    MPTRACE("DolitMediaPlayer_start");
    IjkMediaPlayer *mp = jni_get_media_player(env, thiz);
...
{
    MPTRACE("DolitMediaPlayer_seekTo");
    IjkMediaPlayer *mp = jni_get_media_player(env, thiz);
...
{
    MPTRACE("DolitMediaPlayer_release");
    IjkMediaPlayer *mp = jni_get_media_player(env, thiz);
    if (!mp)
        return;
...
{
    MPTRACE("DolitMediaPlayer_reset");
    IjkMediaPlayer *mp = jni_get_media_player(env, thiz);
    if (!mp)
        return;
...
{
    MPTRACE("DolitMediaPlayer_setVolume");
    IjkMediaPlayer *mp = jni_get_media_player(env, thiz);
...
{
    MPTRACE("DolitMediaPlayer_setAvFormatOption");
    IjkMediaPlayer *mp = jni_get_media_player(env, thiz);
...
{
    MPTRACE("DolitMediaPlayer_setAvCodecOption");
    IjkMediaPlayer *mp = jni_get_media_player(env, thiz);
    const char *c_name = NULL;
    const char *c_value = NULL;
...
{
    MPTRACE("DolitMediaPlayer_setSwScaleOption");
    IjkMediaPlayer *mp = jni_get_media_player(env, thiz);
    const char *c_name = NULL;
    const char *c_value = NULL;
...
{
    MPTRACE("DolitMediaPlayer_setOverlayFormat");
    IjkMediaPlayer *mp = jni_get_media_player(env, thiz);
    JNI_CHECK_GOTO(mp, env, "java/lang/IllegalStateException", "mpjni: setAvCodecOption: null mp", LABEL_RETURN);
...
{
    MPTRACE("DolitMediaPlayer_setFrameDrop");
    IjkMediaPlayer *mp = jni_get_media_player(env, thiz);
...
{
    MPTRACE("DolitMediaPlayer_native_init");
}

static void
IjkMediaPlayer_native_setup(JNIEnv *env, jobject thiz, jobject weak_this)
{    
    MPTRACE("DolitMediaPlayer_native_setup");
    unsigned char certBuf[32] = {0};
    memcpy(certBuf, g_cert, 32);
    Encrypt(certBuf, 32, &g_rc4);
    if(is_equal((char*)certBuf) != 0)
    {
        MPTRACE("DolitMediaPlayer initialized failed , not valid call! ");
        return;
    }
...
{
    MPTRACE("DolitMediaPlayer_native_finalize");
    IjkMediaPlayer_release(env, thiz);
}
...
static JNINativeMethod g_methods[] = {
	...
	{ "native_KeyInit", "(Ljava/lang/String;Ljava/lang/String;Landroid/content/Context;)I",  (void *) IjkMediaPlayer_native_KeyInit },
