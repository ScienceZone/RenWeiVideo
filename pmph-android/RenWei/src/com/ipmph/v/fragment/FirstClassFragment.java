...
public class FirstClassFragment extends LazyLoadFragment implements
		NetRequestIterface, OnClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view = LayoutInflater.from(getActivity()).inflate(
				R.layout.firstclass_fragment, null);
	...
	private void initViews(View view) {
		...
		first_class_viewpager = (ViewPager) view
				.findViewById(R.id.first_class_viewpager);
		...
		if (requestUrl.equals(interface0)) {
			try {
				...
				FirstClassPagerAdapter imagePagerAdapter = new FirstClassPagerAdapter(
						videoclassName, getChildFragmentManager(), carouselList);
