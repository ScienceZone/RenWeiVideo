...
public class ThreadDAOImple implements ThreadDAO {
	...
	// 查询所有数据
	public synchronized List<ThreadInfo> getAllData(String table) {
		SQLiteDatabase db = dbHelper.getReadableDatabase();
		...
		while (cursor.moveToNext()) {
			...
			thread.setUrl(cursor.getString(cursor.getColumnIndex("fileUrl")));
...
//	@Override
//	public synchronized void updateStatus(String url, int thread_id,
//			long finished) {
//		SQLiteDatabase db = dbHelper.getReadableDatabase();
//		
//		db.execSQL(
...
//	}
	...
	public boolean isExists(String url, int thread_id) {
		SQLiteDatabase db = dbHelper.getReadableDatabase();
		Cursor cursor = db.query("thread_info", null,
				"url = ? and thread_id = ?",
