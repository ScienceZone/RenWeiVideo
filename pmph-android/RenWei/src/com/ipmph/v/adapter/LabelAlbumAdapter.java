...
import com.ipmph.v.object.AlbumDetailObject.AlbumContentObject.VideoLabelObject;

public class LabelAlbumAdapter extends BaseAdapter {
	...
	public LabelAlbumAdapter(List<VideoLabelObject> list, Context context) {
		this.list = list;
