...
public class WatchRecordAdapter extends BaseAdapter {
	...
	List<WatchRecordObject> videoList;
	LayoutInflater inflater;
	private Context context;
	private boolean showDeleteIcon = false;
	private Handler handler;

	public WatchRecordAdapter(List<WatchRecordObject> videoList,
	...
	public void changeData(List<WatchRecordObject> videoList) {
		this.videoList = videoList;
		notifyDataSetChanged();
	}
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		final WatchRecordObject object = videoList.get(position);
		...
		holder.delete_layout.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				String watchrecordID = object.watchrecordID;
				Bundle bundle = new Bundle();
				bundle.putString("watchrecordID", watchrecordID);
				msg.setData(bundle);
